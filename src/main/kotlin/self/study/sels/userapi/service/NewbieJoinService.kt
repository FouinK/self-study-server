package self.study.sels.userapi.service
...
class NewbieJoinService {
    fun createNewbieQuestionPOJOs(): List<QuestionPOJO> = listOf(
        QuestionPOJO(
    ...
    private fun answersWithCorrect(correct: String, wrongs: List<String>): List<AnswerPOJO> = listOf(
        AnswerPOJO(correct, correctYn = true),
    ) + wrongs.map {
        AnswerPOJO(it)
    }
}
